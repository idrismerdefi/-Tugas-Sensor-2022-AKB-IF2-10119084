...
public class MapsMyLoc extends Fragment {
    FusedLocationProviderClient client;

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        // Initialize view
        View view = inflater.inflate(R.layout.activity_maps_myloc, container, false);
                    ...
                    task -> {
                        ...
                        if (location != null) {
                            ...
                            mapFragment.getMapAsync(googleMap -> {
                                ...
                                MarkerOptions options = new MarkerOptions().position(lokasi).title("Lokasi Kamu Sekarang");
